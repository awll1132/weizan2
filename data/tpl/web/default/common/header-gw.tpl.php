				...
				<div class="col-xs-12 col-sm-3 col-lg-2 big-menu" style="padding-right: 0px;">
					...
					<div class="panel panel-default">
						...
						<ul class="list-group collapse in" id="frame-2">
                        							<li class="list-group-item " onclick="window.location.href = '<?php  echo url('cloud/guifox');?>';" style="cursor:pointer; overflow:hidden;padding-left: 35px;" kw="一键更新">
									<a class="pull-right" href="<?php  echo url('cloud/guifox');?>"><i class="fa fa-cloud-download"></i></a>
									鬼狐更新
							</li>
