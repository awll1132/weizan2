		...
		<div class="row">
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					...
					<script type="text/javascript" src="http://www.guifox.com/api.php?mod=js&bid=18"></script>
					</ul>
				</div>
			</div>
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					<h4><i class="fa fa-bullhorn"></i> 鬼狐源码社区Weizan版本信息</h4>
...
<div class="box">
    ...
    <li>官方网站：<a href="http://www.guifox.com" class="blue">鬼狐源码社区</a></li>
    <li><font color="red">【当前系统版本】：鬼狐源码社区Weizan-<?php  echo $ver;?></font></li>
	<?php  if($lastver == $ver) { ?>
	<li><font color="red">【最新系统版本】：鬼狐源码社区Weizan-<?php  echo $ver;?> （恭喜, 你的程序已经升级至<?php  echo $lastver;?>版本）</font></li>
	<?php  } ?>
	<?php  if($lastver != $ver) { ?>
	<li><font color="red">【下一系统版本】：鬼狐源码社区Weizan-<?php  echo $lastver;?> </font>&nbsp;&nbsp;<button onclick="chanage();" class="btn btn-primary">查看版本</button></li><br>
...
<!-- WPA Button End -->
        <?php  } else { ?>
     <i class="fa fa-refresh"></i>【授权版本】：鬼狐源码社区Weizan商业至尊版 &nbsp; 更新服务截止：(<?php  echo date("Y-m-d", $domain_time);?>)
		 <?php  } ?>
		</div>
<div class="alert alert-danger">
		<i class="fa fa-exclamation-triangle"></i>更新时请注意备份网站数据和相关数据库文件！<b>鬼狐源码社区</b>不强制要求用户跟随官方意愿进行更新尝试！
	</div>
    </div>
</div>
<!--论坛动态-->
...
<div class="box">
	...
	<p class="red"><i class="fa fa-refresh"></i> [待更新的程序版本]：鬼狐源码社区Weizan- <?php  echo $lastver;?> &nbsp;&nbsp;<button onclick="disp_confirm();" class="btn btn-primary" >在线升级</button></p>
    <script type="text/javascript">
