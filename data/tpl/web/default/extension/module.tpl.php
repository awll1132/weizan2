			...
			<div class="media">
				<div class="pull-right" style="width:500px;">
					...
					<div class="module-set">
						...
						<!--<span class="label label-primary"> <a style="color:#fff" href="http://www.guifox.com">
	...
	<div class="module form-horizontal ng-cloak" ng-controller="listInstallModules">
		<div class="item" ng-repeat="m in modules">
			<div class="media">
				...
				<img class="media-object img-rounded gray" ng-src="http://addons2.012wz.com/resource/attachment/{{m.thumb}}" onerror="this.src='../web/resource/images/nopic-small.jpg'">
				<div class="media-body">
					<h4 class="media-heading">
						{{m.title}}<small>（标识：{{m.name}}&nbsp;&nbsp;&nbsp;版本：{{m.version}}&nbsp;&nbsp;&nbsp;作者：{{m.author}}）</small>
					</h4>
